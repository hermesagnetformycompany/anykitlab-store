...
export default async function CollectionPage({params}: {params: Promise<{id: string}>}) {
  ...
  return (
    <div className="collection-page">
      ...
      <section className="collection-why"><div><h2>Why shop by<br />collection</h2></div><span>▥ <b>Focused selection</b><small>Products are grouped around a clear business goal.</small></span><span>✎ <b>Editable formats</b><small>See each product page for exact included formats.</small></span><span>◷ <b>Save setup time</b><small>Start with a coordinated kit instead of a blank page.</small></span><span>◎ <b>Clear purchase details</b><small>Pricing, contents and delivery terms are shown before checkout.</small></span></section>
